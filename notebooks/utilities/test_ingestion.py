...
v_result = dbutils.notebook.run('../ingestion/customer.py', 0, {"p_file_date": p_file_date})
v_result


v_result = dbutils.notebook.run('../ingestion/customerDrivers.py', 0, {"p_file_date": p_file_date})
v_result


v_result = dbutils.notebook.run('../ingestion/loanTransactions.py', 0, {"p_file_date": p_file_date})
v_result


# Uncomment this lines when you get to Part Enrichment
# Enrichment customer doesn't need the file date param. 
# v_result = dbutils.notebook.run('../enrichment/customer.py', 0)
# v_result


# Uncomment this lines when you get to Part Enrichment
# v_result = dbutils.notebook.run('../enrichment/loanTrx.py', 0, {"p_file_date": p_file_date})
# v_result
